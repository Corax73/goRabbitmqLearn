...
type Callback func(*rmq.Worker, amqp091.Delivery)

func GetSender(worker *rmq.Worker) *SenderWorker {
	return &SenderWorker{worker}
}

func (senderWorker *SenderWorker) GetHandle() Callback {
	return func(worker *rmq.Worker, msg amqp091.Delivery) {
